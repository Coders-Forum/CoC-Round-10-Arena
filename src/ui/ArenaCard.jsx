export default function ArenaCard({ side, accentColor, glowColor, title, subtitle, tags, description }) {
    ...
    return (
        <div style={{
            ...
            boxShadow: `0 0 20px ${glowColor}33, inset 0 0 30px ${glowColor}11`,
